...
public class MailUtil {
    ...
    private static final String USERNAME = "nteo9820@gmail.com"; // Email gửi đi
    private static final String PASSWORD = "cjxy fpgh ivyd emrk"; // App password hoặc mật khẩu ứng dụng
