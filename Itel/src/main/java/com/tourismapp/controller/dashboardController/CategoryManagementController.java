        ...
        switch (action) {
            case MainControllerServlet.ACTION_CREATE_CATEGORY:
                if (name != null && !name.isEmpty()) {
                    Category newCategory = new Category(name, description, imageUrl, statusParam != null ? Status.valueOf(statusParam) : null);
            ...
            case MainControllerServlet.ACTION_EDIT_CATEGORY:
                ...
                if (findCategory.isPresent()) {
                    ...
                    if (statusParam != null) cat.setStatus(Status.valueOf(statusParam.toUpperCase()));
