...
public class MainControllerServlet extends HttpServlet {
    ...
    // cart 
    public static final String ACTION_ADD_ITEMS = "add-items";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case LOGINPAGE_REDIRECT, LOGOUTPAGE_REDIRECT, PRODUCTPAGE_REDIRECT, HOMEPAGE_REDIRECT, CARTPAGE_REDIRECT,
                 DASHBOARDPAGE_REDIRECT, USER_MANAGEMENT_REDIRECT, BRAND_MANAGEMENT_REDIRECT, CATEGORY_MANAGEMENT_REDIRECT,
                 PRODUCT_MANAGEMENT_REDIRECT, ORDER_MANAGEMENT_REDIRECT ->
            ...
            case ACTION_MANAGE_BRAND, ACTION_FIND_BRAND, ACTION_NAVIGATE_TO_CREATE_BRAND, ACTION_NAVIGATE_TO_UPDATE_BRAND ->
                request.getRequestDispatcher(BRAND_MANAGEMENT_REDIRECT).forward(request, response);
            case ACTION_CREATE_CATEGORY_FORM, ACTION_SEARCH_CATEGORY, ACTION_UPDATE_CATEGORY_FORM ->
                request.getRequestDispatcher(CATEGORY_MANAGEMENT_REDIRECT).forward(request, response);
            case ACTION_VIEW_PROFILE, ACTION_EDIT_PROFILE, PROFILEPAGE_REDIRECT ->
                request.getRequestDispatcher(PROFILEPAGE_SERVLET).forward(request, response);
            default ->
                response.sendRedirect("errorAtMainController.jsp");
        }
