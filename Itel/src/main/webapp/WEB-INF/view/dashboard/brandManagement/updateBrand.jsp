        ...
        <div class="form-container">
            <form action="main" method="POST" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="country" name="country" value="${brand.country}" required>
                    <span id="countryError" class="error-message"></span>
                </div>
                <div class="form-group">
                    <label for="description">Description:</label>
                    <textarea id="description" name="description" required>${brand.description}</textarea>
                    <span id="descriptionError" class="error-message"></span>
                </div>
                <div class="form-group">
                    <label for="imageUrl">Image URL:</label>
                    <input type="text" id="imageUrl" name="imageUrl" value="${brand.imageUrl}" required>
