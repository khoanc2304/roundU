...
<head>
    ...
    <meta name="description" content="Thêm người dùng mới với giao diện xanh trắng sáng, futuristic và tương tác đỉnh cao">
...
<body>
    ...
    <div class="container">
        ...
        <form action="main" method="post" class="form-grid" id="createForm">
            ...
            <button type="submit"><svg viewBox="0 0 24 24" style="width: 1.5rem; height: 1.5rem; fill: currentColor; vertical-align: middle; margin-right: 0.75rem;"><path d="M17 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4zm-5 16c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm3-10H5V5h10v4z"/></svg>Tạo</button>
        </form>
    </div>
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (isValid && confirm('Bạn có chắc chắn muốn tạo người dùng mới?')) {
