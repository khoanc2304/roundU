...
<html lang="vi">
        ...
        <div class="container">
            ...
            <div class="form-card">
                ...
                <form id="userForm" action="main" method="post">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" id="username" name="username" class="form-input ${not empty errors['username'] ? 'error' : ''}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="password" id="password" name="password"
                                           class="form-input ${not empty errors['password'] ? 'error' : ''}"
                                ...
                                <!-- Xóa dòng tooltip hoặc cập nhật nội dung -->
                                <div class="tooltip">Mật khẩu không được để trống</div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" id="fullName" name="fullName" class="form-input ${not empty errors['fullName'] ? 'error' : ''}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="email" id="email" name="email" class="form-input ${not empty errors['email'] ? 'error' : ''}"
                                ...
                                <div class="tooltip">Email phải hợp lệ và không trùng</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" id="phone" name="phone" class="form-input ${not empty errors['phone'] ? 'error' : ''}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" id="address" name="address" class="form-input ${not empty errors['address'] ? 'error' : ''}"
                    ...
                    <!-- giữ nguyên phần chọn role và membership như cũ -->
    ...
    //
    //        form.submit(); // ✅ Submit ngay lập tức sau khi xác nhận
    //    }
    //});
