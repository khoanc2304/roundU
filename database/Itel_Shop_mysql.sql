...
-- DROP DATABASE IF EXISTS Itel_Shop;
...
CREATE TABLE Payment (
    ...
    payment_method ENUM ('cash', 'banking', 'cash_on_delivery') NOT NULL,
...
CREATE TABLE ProductImages (
    image_id INT AUTO_INCREMENT PRIMARY KEY,  -- Sử dụng IDENTITY để tự động tăng
    product_id INT,
...
('khoa1', 'khoa1', 'Nguyen khoa', 'khoa1@gmail.com', '0987654321', '456 Đường B, Hà Nội', 'admin', 4, 'https://i.pinimg.com/736x/16/a9/57/16a9570117787327d84c592bb7dd01c6.jpg'),
('kha', 'kha', 'Nguyen Ja', 'kha@gmail.com', '0912345678', '789 Đường C, Đà Nẵng', 'admin', 4, 'https://i.pinimg.com/736x/1c/4b/12/1c4b12f45f56d1d37934dde85af2f4d4.jpg'),
('tuan', 'tuan', 'Tuan Tran', 'tuan@gmail.com', '0909876543', '12 Đường D, Hải Phòng', 'admin', 4, 'https://i.pinimg.com/736x/bf/50/e2/bf50e22082af5810b2976308c721ee5b.jpg'),
...
('Nokia  Earbuds+', 'Budget wireless earbuds with 20-hour battery', 781275, 110, 4, 14, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQXAiBYVepZP2H0uEnAhzU04JdKsZ78_N5VA&s'),
...
-- Nokia  Earbuds+ (product_id=95, category_id=4)
...
(3, 1, 5, 'Perfect for gaming, solid GPU performance.', '2025-05-29 10:00:00'), -- Legion Y520
(5, 1, 3, 'Good specs, but a bit pricey.', '2025-05-31 09:00:00'), -- ZenBook UX430UN
(1, 2, 5, 'Amazing camera and performance!', '2025-06-01 14:00:00'), -- iPhone 16
(2, 2, 4, 'Powerful laptop, but battery life could be better.', '2025-06-05 10:00:00'), -- MacBook Pro 14 M4 Pro
(3, 2, 5, 'Great value for money, sleek design.', '2025-06-10 16:00:00'), -- Samsung Galaxy S25
(4, 2, 4, 'Excellent display, but a bit heavy.', '2025-06-15 09:00:00'), -- DELL XPS 15
(1, 3, 5, 'Stunning display and camera!', '2025-06-16 10:00:00'), -- iPhone 16 Pro
(2, 3, 4, 'Lightweight and powerful, but pricey.', '2025-06-17 12:00:00'), -- MacBook Air 15 M4
(3, 3, 5, 'Great AMOLED screen, fast performance.', '2025-06-18 14:00:00'), -- Samsung Galaxy S25 Plus
(4, 3, 4, 'Excellent for work, good battery life.', '2025-06-19 09:00:00'), -- DELL XPS 17
(1, 5, 3, 'Good for gaming, but fans are loud.', '2025-06-20 11:00:00'), -- ASUS ROG Zephyrus G16
(2, 5, 5, 'Best iPhone yet, love the design.', '2025-06-21 15:00:00'), -- iPhone 17 Pro
(3, 5, 4, 'Affordable and reliable phone.', '2025-06-22 13:00:00'), -- Samsung Galaxy A36
(4, 5, 5, 'Perfect for professionals, fast M4 Pro.', '2025-06-23 10:00:00'), -- MacBook Pro 14 M4 Pro
(5, 5, 4, 'Compact and powerful, great for travel.', '2025-06-24 16:00:00'), -- iPhone 16 Mini
(1, 6, 5, 'Stylish foldable, great display.', '2025-06-25 08:00:00'), -- Samsung Galaxy Z Flip 7
(2, 6, 4, 'Ideal for creators, vibrant OLED screen.', '2025-06-26 12:00:00'), -- ASUS ProArt P16
(3, 6, 5, 'Thin and light, amazing performance.', '2025-06-27 14:00:00'), -- iPhone 17 Air
...
(95, 'https://manuals.plus/wp-content/uploads/2022/10/NOKIA-TWS-201--Earbuds-Wireless-Earbuds-Featured-Image.jpg', 0, 'active'),
-- MacBook Air 13-inch M4 2025 (product_id=96, category_id=1)
...
INSERT INTO Review (product_id, user_id, rating, comment, parent_review_id, created_at)
VALUES
(1, 2, 5, N'Excellent performance, sleek design, worth the price!', 1,'2025-02-01 10:00:00'),
(1, 3, 4, N'Great laptop but battery life could be better.', 1,'2025-02-02 12:00:00'),
(1, 4, 4, N'Smooth macOS experience, very fast.', 2,'2025-02-03 14:00:00'),
(2, 5, 4, N'Lightweight and portable, perfect for travel.', 2,'2025-02-04 09:00:00'),
(2, 5, 4, N'Good for daily tasks, but a bit pricey.', 2,'2025-02-05 11:00:00'),
(3, 6, 4, N'Decent performance for the price, reliable.', 3, '2025-02-06 13:00:00'),
(3, 7, 3, N'Okay for basic use, but not for heavy tasks.', 3, '2025-02-07 15:00:00'),
(4, 8, 5, N'Powerful laptop, great for video editing.', 4, '2025-02-08 10:00:00'),
(4, 9, 5, N'Love the Retina display, very crisp!', 4, '2025-02-09 12:00:00'),
(4, 10, 4, N'High performance but quite expensive.', 5, '2025-02-10 14:00:00'),
(5, 11, 4, N'Great for professionals, fast processor.', 5, '2025-02-11 09:00:00'),
(5, 12, 5, N'Solid build quality, highly recommend.', 6, '2025-02-12 11:00:00'),
(6, 13, 4, N'Good performance, but fan noise is noticeable.', 6, '2025-02-13 13:00:00'),
(6, 14, 4, N'Reliable for daily use, good display.', 7, '2025-02-14 15:00:00'),
(7, 15, 4, N'Perfect for students, lightweight.', 7, '2025-02-15 10:00:00'),
(7, 1, 4, N'Great value for a MacBook.', 8, '2025-02-16 12:00:00'),
(8, 2, 4, N'Slim design, good for multitasking.', 8, '2025-02-17 14:00:00'),
(8, 3, 5, N'Love the Nvidia graphics, smooth experience.', 9, '2025-02-18 09:00:00'),
(9, 4, 4, N'Good budget laptop, decent display.', 9, '2025-02-19 11:00:00'),
(9, 5, 3, N'Average performance, expected more.', 10, '2025-02-20 13:00:00'),
(10, 6, 4, N'Affordable and reliable for basic tasks.', 10, '2025-02-21 15:00:00'),
(10, 7, 3, N'Not great for multitasking.', 11, '2025-02-22 10:00:00'),
(11, 8, 5, N'Fantastic performance, premium build.', 11, '2025-02-23 12:00:00'),
(11, 9, 4, N'Great for professionals, bit pricey.', 12, '2025-02-24 14:00:00'),
(12, 10, 4, N'Good for students, decent performance.', 12, '2025-02-25 09:00:00'),
(12, 11, 3, N'Slightly outdated hardware.', 13, '2025-02-26 11:00:00'),
(13, 12, 4, N'Compact and lightweight, great for travel.', 13, '2025-02-27 13:00:00'),
(13, 13, 4, N'Nice display, but limited ports.', 14, '2025-02-28 15:00:00'),
(14, 14, 4, N'Good performance for the price.', 14, '2025-03-01 10:00:00'),
(14, 15, 4, N'Reliable laptop, decent graphics.', 15, '2025-03-02 12:00:00'),
(15, 1, 5, N'Top-tier performance, worth every penny.', 15, '2025-03-03 14:00:00'),
(15, 2, 5, N'Best MacBook for professionals.', 16, '2025-03-04 09:00:00'),
(16, 3, 4, N'Good for casual use, decent specs.', 16, '2025-03-05 11:00:00'),
(16, 4, 3, N'Not great for gaming.', 17, '2025-03-06 13:00:00'),
(17, 5, 4, N'Sleek design, great touchscreen.', 17, '2025-03-07 15:00:00'),
(17, 6, 4, N'Fast processor, good for work.', 18, '2025-03-08 10:00:00'),
(18, 7, 3, N'Basic laptop, good for light tasks.', 18, '2025-03-09 12:00:00'),
(18, 8, 4, N'Great for budget users.', 19, '2025-03-10 14:00:00'),
(19, 9, 5, N'Awesome gaming laptop, runs smoothly.', 19, '2025-03-11 09:00:00'),
(19, 10, 4, N'Good for gaming, but a bit heavy.', 20, '2025-03-12 11:00:00'),
(20, 11, 4, N'Affordable, decent for daily use.', 20, '2025-03-13 13:00:00'),
(20, 12, 3, N'Not very powerful.', null, '2025-03-14 15:00:00'),
(21, 13, 4, N'Nice 2-in-1, versatile design.', null, '2025-03-15 10:00:00'),
(21, 14, 4, N'Good touchscreen, reliable.', null, '2025-03-16 12:00:00'),
(22, 15, 4, N'Solid performance for the price.', null, '2025-03-17 14:00:00'),
(22, 1, 3, N'Display could be better.', null, '2025-03-18 09:00:00'),
(23, 2, 4, N'Good for multitasking, nice graphics.', null, '2025-03-19 11:00:00'),
(23, 3, 4, N'Reliable laptop, good value.', null, '2025-03-20 13:00:00'),
(24, 4, 4, N'Great for business, fast SSD.', null, '2025-03-21 15:00:00'),
(24, 5, 4, N'Solid build, good for work.', null, '2025-03-22 10:00:00'),
(25, 6, 4, N'Large display, good for productivity.', null, '2025-03-23 12:00:00'),
(25, 7, 4, N'Reliable, good for office use.', null, '2025-03-24 14:00:00'),
(26, 8, 4, N'Affordable, decent performance.', null, '2025-03-25 09:00:00'),
(26, 9, 3, N'Not great for heavy tasks.', null, '2025-03-26 11:00:00'),
(27, 10, 5, N'Fantastic display, very fast.', null, '2025-03-27 13:00:00'),
(27, 11, 4, N'Great laptop, but expensive.', null, '2025-03-28 15:00:00'),
(28, 12, 3, N'Basic laptop, good for light use.', null, '2025-03-29 10:00:00'),
(28, 13, 4, N'Affordable and reliable.', null, '2025-03-30 12:00:00'),
(29, 14, 4, N'Good for daily tasks, nice design.', null, '2025-03-31 14:00:00'),
(29, 15, 4, N'Reliable, good storage options.', null, '2025-04-01 09:00:00'),
(30, 1, 4, N'Good performance, nice keyboard.', null, '2025-04-02 11:00:00'),
(30, 2, 3, N'Could use better graphics.', null, '2025-04-03 13:00:00'),
(31, 3, 4, N'Affordable, good for students.', null, '2025-04-04 15:00:00'),
(31, 4, 3, N'Basic specs, not for heavy use.', null, '2025-04-05 10:00:00'),
(32, 5, 5, N'Great gaming laptop, high performance.', null, '2025-04-06 12:00:00'),
(32, 6, 4, N'Smooth gaming experience.', null, '2025-04-07 14:00:00'),
(33, 7, 4, N'Good for casual use, decent graphics.', null, '2025-04-08 09:00:00'),
(33, 8, 3, N'Average performance.', null, '2025-04-09 11:00:00'),
(34, 9, 4, N'Nice display, good for work.', null, '2025-04-10 13:00:00'),
(34, 10, 4, N'Reliable, good value.', null, '2025-04-11 15:00:00'),
(35, 11, 4, N'Versatile 2-in-1, good performance.', null, '2025-04-12 10:00:00'),
(35, 12, 4, N'Great touchscreen, nice design.', null, '2025-04-13 12:00:00'),
(36, 13, 4, N'Solid MacBook, good for daily use.', null, '2025-04-14 14:00:00'),
(36, 14, 4, N'Nice display, reliable.', null, '2025-04-15 09:00:00'),
(37, 15, 4, N'Affordable, good for students.', null, '2025-04-16 11:00:00'),
(37, 1, 3, N'Basic specs, not for heavy tasks.', null, '2025-04-17 13:00:00'),
(38, 2, 5, N'Great gaming laptop, awesome performance.', null, '2025-04-18 15:00:00'),
(38, 3, 4, N'Smooth gaming, nice design.', null, '2025-04-19 10:00:00'),
(39, 4, 4, N'Good for work, reliable.', null, '2025-04-20 12:00:00'),
(39, 5, 4, N'Decent performance, good value.', null, '2025-04-21 14:00:00'),
(40, 6, 5, N'Excellent mouse, very precise.', null, '2025-04-22 09:00:00'),
(40, 7, 4, N'Great for productivity, comfortable.', null, '2025-04-23 11:00:00'),
(41, 8, 4, N'Awesome keyboard, great for gaming.', null, '2025-04-24 13:00:00'),
(41, 9, 4, N'Nice RGB lighting, responsive.', null, '2025-04-25 15:00:00'),
(42, 10, 4, N'Great for iPad, very versatile.', null, '2025-04-26 10:00:00'),
(42, 11, 4, N'Good build quality, reliable.', null, '2025-04-27 12:00:00'),
(43, 12, 5, N'Perfect gaming mouse, very light.', null, '2025-04-28 14:00:00'),
(43, 13, 4, N'Great precision, good for eSports.', null, '2025-04-29 09:00:00'),
(44, 14, 4, N'Nice keyboard, great for typing.', null, '2025-04-30 11:00:00'),
(44, 15, 4, N'Solid build, good for macOS.', null, '2025-05-01 13:00:00'),
(45, 1, 5, N'Powerful gaming laptop, great display.', null, '2025-05-02 15:00:00'),
(45, 2, 4, N'Smooth gaming, good value.', null, '2025-05-03 10:00:00'),
(46, 3, 4, N'Sleek gaming laptop, high performance.', null, '2025-05-04 12:00:00'),
(46, 4, 4, N'Great for gaming, lightweight.', null, '2025-05-05 14:00:00'),
(47, 5, 4, N'Good for business, reliable.', null, '2025-05-06 09:00:00'),
(47, 6, 4, N'Solid performance, nice design.', null, '2025-05-07 11:00:00'),
(48, 7, 5, N'Excellent for creators, high-end specs.', null, '2025-05-08 13:00:00'),
(48, 8, 4, N'Great 4K display, powerful.', null, '2025-05-09 15:00:00'),
(49, 9, 5, N'Awesome gaming laptop, fast refresh rate.', null, '2025-05-10 10:00:00'),
(49, 10, 4, N'Great for gaming, solid build.', null, '2025-05-11 12:00:00'),
(50, 11, 4, N'Beautiful OLED display, great for creators.', null, '2025-05-12 14:00:00'),
(50, 12, 4, N'Solid performance, nice design.', null, '2025-05-13 09:00:00'),
(51, 13, 4, N'Good budget gaming laptop.', null, '2025-05-14 11:00:00'),
(51, 14, 4, N'Decent performance, good value.', null, '2025-05-15 13:00:00'),
(52, 15, 5, N'Best flagship phone, amazing camera.', null, '2025-05-16 15:00:00'),
(52, 1, 5, N'Great performance, sleek design.', null, '2025-05-17 10:00:00'),
(53, 2, 4, N'Good mid-range phone, nice display.', null, '2025-05-18 12:00:00'),
(53, 3, 4, N'Reliable, good for daily use.', null, '2025-05-19 14:00:00'),
(54, 4, 5, N'Fantastic foldable phone, great display.', null, '2025-05-20 09:00:00'),
(54, 5, 4, N'Smooth performance, innovative design.', null, '2025-05-21 11:00:00'),
(55, 6, 4, N'Great flagship phone, fast processor.', null, '2025-05-22 13:00:00'),
(55, 7, 4, N'Nice display, good camera.', null, '2025-05-23 15:00:00'),
(56, 8, 4, N'Solid mid-range phone, good value.', null, '2025-05-24 10:00:00'),
(56, 9, 4, N'Great AMOLED display, reliable.', null, '2025-05-25 12:00:00'),
(57, 10, 4, N'Affordable 5G phone, decent specs.', null, '2025-05-26 14:00:00'),
(57, 11, 3, N'Basic phone, good for budget users.', null, '2025-05-27 09:00:00'),
(58, 12, 5, N'Excellent camera, great performance.', null, '2025-05-28 11:00:00'),
(58, 13, 4, N'Solid flagship, nice design.', null, '2025-05-29 13:00:00'),
(59, 14, 4, N'Good mid-range phone, reliable.', null, '2025-05-30 15:00:00'),
(59, 15, 4, N'Nice performance, good value.', null, '2025-05-31 10:00:00'),
(60, 1, 4, N'Affordable, good for daily use.', null, '2025-06-01 12:00:00'),
(60, 2, 3, N'Basic specs, not for heavy tasks.', null, '2025-06-02 14:00:00'),
(61, 3, 5, N'Great flagship phone, awesome camera.', null, '2025-06-03 09:00:00'),
(61, 4, 4, N'Solid performance, nice design.', null, '2025-06-04 11:00:00'),
(62, 5, 4, N'Good mid-range phone, reliable.', null, '2025-06-05 13:00:00'),
(62, 6, 4, N'Nice display, good value.', null, '2025-06-06 15:00:00'),
(63, 7, 4, N'Affordable, decent performance.', null, '2025-06-07 10:00:00'),
(63, 8, 3, N'Basic phone, good for budget users.', null, '2025-06-08 12:00:00'),
(64, 9, 5, N'Great flagship phone, fast processor.', null, '2025-06-09 14:00:00'),
(64, 10, 4, N'Solid performance, good display.', null, '2025-06-10 09:00:00'),
(65, 11, 4, N'Good mid-range phone, nice camera.', null, '2025-06-11 11:00:00'),
(65, 12, 4, N'Reliable, good value.', null, '2025-06-12 13:00:00'),
(66, 13, 4, N'Affordable, decent specs.', null, '2025-06-13 15:00:00'),
(66, 14, 3, N'Basic phone, good for budget users.', null, '2025-06-14 10:00:00'),
(67, 15, 4, N'Solid mid-range phone, reliable.', null, '2025-06-15 12:00:00'),
(67, 1, 4, N'Good performance, nice display.', null, '2025-06-16 14:00:00'),
(68, 2, 4, N'Affordable 5G phone, decent specs.', null, '2025-06-17 09:00:00'),
(68, 3, 3, N'Basic phone, good for light use.', null, '2025-06-18 11:00:00'),
(69, 4, 4, N'Entry-level phone, good value.', null, '2025-06-19 13:00:00'),
(69, 5, 3, N'Not great for heavy tasks.', null, '2025-06-20 15:00:00'),
(70, 6, 4, N'Great keyboard, awesome for gaming.', null, '2025-06-21 10:00:00'),
(70, 7, 4, N'Solid build, nice RGB.', null, '2025-06-22 12:00:00'),
(71, 8, 4, N'Good gaming mouse, very responsive.', null, '2025-06-23 14:00:00'),
(71, 9, 4, N'Nice design, good for gaming.', null, '2025-06-24 09:00:00'),
(72, 10, 4, N'Excellent keyboard, great for gaming.', null, '2025-06-25 11:00:00'),
(72, 11, 4, N'Solid performance, nice switches.', null, '2025-06-26 13:00:00'),
(73, 12, 5, N'Awesome gaming mouse, very light.', null, '2025-06-27 15:00:00'),
(73, 13, 4, N'Great for eSports, precise.', null, '2025-06-28 10:00:00'),
(74, 14, 4, N'Nice keyboard, great for typing.', null, '2025-06-29 12:00:00'),
(74, 15, 4, N'Solid build, reliable.', null, '2025-06-30 14:00:00'),
(75, 1, 4, N'Good gaming mouse, very comfortable.', null, '2025-07-01 09:00:00'),
(75, 2, 4, N'Nice design, good precision.', null, '2025-07-02 11:00:00'),
(76, 3, 5, N'Great earbuds, excellent sound quality.', null, '2025-07-03 13:00:00'),
(76, 4, 4, N'Comfortable fit, good for music.', null, '2025-07-04 15:00:00'),
(77, 5, 4, N'Awesome earbuds, great noise cancellation.', null, '2025-07-05 10:00:00'),
(77, 6, 4, N'Solid sound, nice design.', null, '2025-07-06 12:00:00'),
(78, 7, 4, N'Good gaming mouse, responsive.', null, '2025-07-07 14:00:00'),
(78, 8, 4, N'Nice design, good for gaming.', null, '2025-07-08 09:00:00'),
(79, 9, 5, N'Excellent keyboard, great for gaming.', null, '2025-07-09 11:00:00'),
(79, 10, 4, N'Solid build, nice switches.', null, '2025-07-10 13:00:00'),
(80, 11, 4, N'Great gaming mouse, very precise.', null, '2025-07-11 15:00:00'),
(80, 12, 4, N'Nice design, good for eSports.', null, '2025-07-12 10:00:00'),
(81, 13, 5, N'Excellent earbuds, great sound.', null, '2025-07-13 12:00:00'),
(81, 14, 4, N'Comfortable, good for daily use.', null, '2025-07-14 14:00:00'),
(82, 15, 4, N'Good earbuds, nice price.', null, '2025-07-15 09:00:00'),
(82, 1, 4, N'Solid sound quality, reliable.', null, '2025-07-16 11:00:00'),
(83, 2, 4, N'Great earbuds, good noise cancellation.', null, '2025-07-17 13:00:00'),
(83, 3, 4, N'Nice design, comfortable fit.', null, '2025-07-18 15:00:00'),
(84, 4, 4, N'Good earbuds, nice sound.', null, '2025-07-19 10:00:00'),
(84, 5, 4, N'Affordable, reliable.', null, '2025-07-20 12:00:00'),
(85, 6, 4, N'Great earbuds, solid performance.', null, '2025-07-21 14:00:00'),
(85, 7, 4, N'Nice sound quality, good fit.', null, '2025-07-22 09:00:00'),
(86, 8, 4, N'Good earbuds, nice design.', null, '2025-07-23 11:00:00'),
(86, 9, 4, N'Solid performance, affordable.', null, '2025-07-24 13:00:00'),
(87, 10, 5, N'Excellent earbuds, great ANC.', null, '2025-07-25 15:00:00'),
(87, 11, 4, N'Nice sound, good for music.', null, '2025-07-26 10:00:00'),
(88, 12, 4, N'Good earbuds, nice price.', null, '2025-07-27 12:00:00'),
(88, 13, 4, N'Solid sound quality, reliable.', null, '2025-07-28 14:00:00'),
(89, 14, 4, N'Good earbuds, comfortable fit.', null, '2025-07-29 09:00:00'),
(89, 15, 4, N'Nice design, good value.', null, '2025-07-30 11:00:00'),
(90, 1, 4, N'Affordable earbuds, decent sound.', null, '2025-07-31 13:00:00'),
(90, 2, 3, N'Basic earbuds, good for budget users.', null, '2025-08-01 15:00:00'),
(91, 3, 5, N'Excellent MacBook, great performance.', null, '2025-08-02 10:00:00'),
(91, 4, 4, N'Smooth experience, nice display.', null, '2025-08-03 12:00:00'),
(92, 5, 5, N'Best MacBook Pro, high performance.', null, '2025-08-04 14:00:00'),
(92, 6, 5, N'Great for professionals, awesome display.', null, '2025-08-05 09:00:00'),
(93, 7, 5, N'Large display, great for work.', null, '2025-08-06 11:00:00'),
(93, 8, 4, N'Solid performance, nice design.', null, '2025-08-07 13:00:00'),
(94, 9, 5, N'Great iPhone, awesome camera.', null, '2025-08-08 15:00:00'),
(94, 10, 4, N'Smooth performance, nice display.', null, '2025-08-09 10:00:00'),
(95, 11, 4, N'Good iPhone, large display.', null, '2025-08-10 12:00:00'),
(95, 12, 4, N'Reliable, good for daily use.', null, '2025-08-11 14:00:00'),
(96, 13, 5, N'Excellent iPhone, great performance.', null, '2025-08-12 09:00:00'),
(96, 14, 4, N'Smooth experience, nice camera.', null, '2025-08-13 11:00:00'),
(97, 15, 5, N'Best iPhone, awesome display.', null, '2025-08-14 13:00:00'),
(97, 1, 5, N'Great performance, worth the price.', null, '2025-08-15 15:00:00'),
(98, 2, 5, N'Great iPhone, fast processor.', null, '2025-08-16 10:00:00'),
(98, 3, 4, N'Solid performance, nice design.', null, '2025-08-17 12:00:00'),
(99, 4, 4, N'Good iPhone, large display.', null, '2025-08-18 14:00:00'),
(99, 5, 4, N'Reliable, good for daily use.', null, '2025-08-19 09:00:00'),
(100, 6, 5, N'Excellent iPhone, great camera.', null, '2025-08-20 11:00:00'),
(100, 7, 4, N'Smooth performance, nice display.', null, '2025-08-21 13:00:00'),
(101, 8, 5, N'Best iPhone, awesome performance.', null, '2025-08-22 15:00:00'),
(101, 9, 5, N'Great display, worth the price.', null, '2025-08-23 10:00:00'),
(102, 10, 4, N'Good iPhone, nice camera.', null, '2025-08-24 12:00:00'),
(102, 11, 4, N'Solid performance, reliable.', null, '2025-08-25 14:00:00'),
(103, 12, 4, N'Great iPhone, sleek design.', null, '2025-08-26 09:00:00'),
(103, 13, 4, N'Smooth experience, nice display.', null, '2025-08-27 11:00:00'),
(104, 14, 4, N'Compact iPhone, good performance.', null, '2025-08-28 13:00:00'),
(104, 15, 4, N'Reliable, good for daily use.', null, '2025-08-29 15:00:00'),
(105, 1, 4, N'Good iPhone, nice design.', null, '2025-08-30 10:00:00'),
(105, 2, 4, N'Solid performance, good value.', null, '2025-08-31 12:00:00'),
(106, 3, 5, N'Excellent Samsung phone, great camera.', null, '2025-09-01 14:00:00'),
(106, 4, 4, N'Smooth performance, nice display.', null, '2025-09-02 09:00:00'),
(107, 5, 5, N'Great Samsung phone, large display.', null, '2025-09-03 11:00:00'),
(107, 6, 4, N'Reliable, good for daily use.', null, '2025-09-04 13:00:00'),
(108, 7, 5, N'Best Samsung phone, awesome performance.', null, '2025-09-05 15:00:00'),
(108, 8, 5, N'Great display, worth the price.', null, '2025-09-06 10:00:00'),
(109, 9, 5, N'Excellent foldable phone, great display.', null, '2025-09-07 12:00:00'),
(109, 10, 4, N'Smooth performance, innovative design.', null, '2025-09-08 14:00:00'),
(110, 11, 4, N'Great flip phone, nice design.', null, '2025-09-09 09:00:00'),
(110, 12, 4, N'Reliable, good for daily use.', null, '2025-09-10 11:00:00'),
(111, 13, 4, N'Good mid-range phone, nice camera.', null, '2025-09-11 13:00:00'),
(111, 14, 4, N'Solid performance, good value.', null, '2025-09-12 15:00:00'),
(112, 15, 4, N'Affordable, decent specs.', null, '2025-09-13 10:00:00'),
(112, 1, 3, N'Basic phone, good for budget users.', null, '2025-09-14 12:00:00'),
(113, 2, 4, N'Good mid-range phone, reliable.', null, '2025-09-15 14:00:00'),
(113, 3, 4, N'Nice display, good value.', null, '2025-09-16 09:00:00'),
(114, 4, 4, N'Good Samsung phone, nice camera.', null, '2025-09-17 11:00:00'),
(114, 5, 4, N'Solid performance, reliable.', null, '2025-09-18 13:00:00'),
(115, 6, 5, N'Excellent Dell laptop, great performance.', null, '2025-09-19 15:00:00'),
(115, 7, 4, N'Smooth experience, nice display.', null, '2025-09-20 10:00:00'),
(116, 8, 5, N'Great Dell laptop, high performance.', null, '2025-09-21 12:00:00'),
(116, 9, 4, N'Solid build, good for work.', null, '2025-09-22 14:00:00'),
(117, 10, 4, N'Good Dell laptop, nice design.', null, '2025-09-23 09:00:00'),
(117, 11, 4, N'Reliable, good for daily use.', null, '2025-09-24 11:00:00'),
(118, 12, 4, N'Solid Dell laptop, good performance.', null, '2025-09-25 13:00:00'),
(118, 13, 4, N'Nice display, reliable.', null, '2025-09-26 15:00:00'),
(119, 14, 5, N'Excellent ASUS laptop, great performance.', null, '2025-09-27 10:00:00'),
(119, 15, 4, N'Smooth experience, nice design.', null, '2025-09-28 12:00:00'),
(120, 1, 5, N'Great gaming laptop, high performance.', null, '2025-09-29 14:00:00'),
(120, 2, 4, N'Smooth gaming, nice display.', null, '2025-09-30 09:00:00'),
(121, 3, 4, N'Good ASUS laptop, reliable.', null, '2025-10-01 11:00:00'),
(121, 4, 4, N'Nice design, good value.', null, '2025-10-02 13:00:00'),
(122, 5, 4, N'Excellent ASUS laptop, great for creators.', 0, '2025-10-03 15:00:00'),
(122, 6, 4, N'Solid performance, nice display.', 0, '2025-10-04 10:00:00'),
(123, 7, 4, N'Good laptop, reliable performance.', 0, '2025-10-05 12:00:00'),
(123, 8, 4, N'Nice design, good for daily use.', 0, '2025-10-06 14:00:00'),
(124, 9, 4, N'Solid laptop, good value.', 0, '2025-10-07 09:00:00'),
(124, 10, 4, N'Reliable, nice display.', 0, '2025-10-08 11:00:00'),
(125, 11, 4, N'Good laptop, great performance.', 0, '2025-10-09 13:00:00'),
(125, 12, 4, N'Smooth experience, nice design.', 0, '2025-10-10 15:00:00'),
(126, 13, 4, N'Reliable laptop, good for work.', 0, '2025-10-11 10:00:00'),
(126, 14, 4, N'Nice display, solid performance.', 0, '2025-10-12 12:00:00'),
